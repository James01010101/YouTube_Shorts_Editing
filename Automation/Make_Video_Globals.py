...
class Globals:
    ...
    if topic == "Fortnite":
        ...
        font_topic = "Fortnite" # the font for the topic eg (AOT)
        font_title = "Fortnite" # used for Question titles
        font_general_text = "Fortnite" # use for all other text
        ...
        #background
        background_image_path = f"{topic}/Assets/Backgrounds/Background 1.jpg"
        ...
        question_1_font_size = 125
        question_1_position = ("center", -500)
        question_1_timer_position = (75, 650)
        
        answer_1_raw_text = "Wood"
        answer_1_font_size = 200
        answer_1_position = ("center", 575)
        answer_1_image_path = f"{topic}/Assets/Items/Materials/Wood Material.png"
        answer_1_image_helper = True # if it is shown for the whole question or just the answer
        answer_1_image_position = ("center", 600)
        answer_1_image_width = screen_size[0] - 300
        
        
        # Question 2 medium
        question_2_raw_text = "What is the name\nof this weapon?"
        question_2_font_size = 125
        question_2_position = ("center", -500)
        question_2_timer_position = (75, 650)
        
        answer_2_raw_text = "Heavy Sniper\nRifle"
        answer_2_font_size = 150
        answer_2_position = ("center", 575)
        answer_2_image_path = f"{topic}/Assets/Weapons/Sniper/Heavy Sniper Rifle.jpeg"
        answer_2_image_helper = True
        answer_2_image_position = ('center', 625)
        answer_2_image_width = screen_size[0] + 400
        
        
        # Question 3 hard
        question_3_raw_text = "What is the name\nof this Character?"
        question_3_font_size = 115
        question_3_position = ("center", -500)
        question_3_timer_position = (75, 650)
        
        answer_3_raw_text = "Burnout"
        answer_3_font_size = 200
        answer_3_position = ("center", 575)
        answer_3_image_path = f"{topic}/Assets/Characters/Burnout.jpg"
        answer_3_image_helper = True
        answer_3_image_position = ('center', 600)
        answer_3_image_width = screen_size[0] + 425
