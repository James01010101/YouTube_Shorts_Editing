...
(q1_final_video, screenshot_time, saved_parts) = Make_Video_Sections.make_questions(settings, saved_parts, 1, True)
print(f"Q1 Editing and Render Took: {round(time.time() - start_time, 2)} seconds\n\n")